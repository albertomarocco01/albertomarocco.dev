 ...
 *
 * "Image Vortex" is the piece's title and stays as-is in both locales — so does
 * "vortex" on the step-back button, the name's own word; "carousel" there is
 * translated ("carosello").
 */
