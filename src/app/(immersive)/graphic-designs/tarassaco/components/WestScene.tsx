...
export function WestScene({ copy, registerNode, clearNodes, windowWidth, onRevealComplete }: WestSceneProps) {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center z-40 bg-black">
      ...
      <div className={`tara-side absolute left-8 md:left-16 top-1/2 -translate-y-1/2 flex flex-col items-center gap-4 transition-opacity duration-1000 ${showDandelion ? 'opacity-100' : 'opacity-0'}`}>
        <MiniDandelion />
